...
class SolidityObfuscator:
    ...
    def obfuscate(self, input_path, output_path):
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Solidity Obfuscator")
    parser.add_argument('input_path', help="Path to the Solidity contract file to obfuscate")
    parser.add_argument('output_path', help="Path to save the obfuscated Solidity contract file")
    
    args = parser.parse_args()

    obfuscator = SolidityObfuscator()
    output_file = obfuscator.obfuscate(args.input_path, args.output_path)
