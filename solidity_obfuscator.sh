...
solc --import-asm-json --bin-runtime "./tmp/${base_name}_op.asm.json" | tail -1 >"output/${base_name}_obfuscated.bin.runtime"
solc --import-asm-json --bin "./tmp/${base_name}_op.asm.json" | tail -1 >"output/${base_name}_obfuscated.bin"
