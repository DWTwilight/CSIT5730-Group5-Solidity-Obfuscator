...
solc --bin-runtime $1 >"output/${base_name}.bin.runtime"
solc --bin $1 >"output/${base_name}.bin"
...
solc --import-asm-json --bin-runtime "./tmp/${base_name}_rj.asm.json" >"output/${base_name}_obfuscated.bin.runtime"
solc --import-asm-json --bin "./tmp/${base_name}_rj.asm.json" >"output/${base_name}_obfuscated.bin"
